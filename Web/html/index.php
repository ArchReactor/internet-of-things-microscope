...
<input id="focus_knob" type="text" value="0" data-max="100" data-min="-100" class="dial" cursor="10" displayInput="false">
...
<html>
   <head>
      ...
      <title>Ninju <?php echo CAM_STRING; ?></title>
   ...
   <body onload="setTimeout('init(<?php echo "$mjpegmode, $video_fps, $divider" ?>);', 100);">
      ...
      <div class="container-fluid text-center liveimage">
         ...
         <div id="main-buttons" <?php echo $displayStyle; ?> >
            ...
            <br>
            <input id="adv_focus_button" type="button" class="btn btn-primary">
            <input id="ret_focus_button" type="button" class="btn btn-primary">
         </div>
      </div>
