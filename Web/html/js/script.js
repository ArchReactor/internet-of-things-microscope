...
ajax_status.onreadystatechange = function() {
  if(ajax_status.readyState == 4 && ajax_status.status == 200) {
    ...
    if(ajax_status.responseText == "ready") {
      ...
      document.getElementById("adv_focus_button").value = "advance focus";
      document.getElementById("ret_focus_button").value = "retreat focus";

      document.getElementById("adv_focus_button").onclick = function() {send_cmd("adv 10");};
      document.getElementById("ret_focus_button").onclick = function() {send_cmd("ret 10");};
	    updatePreview();
    }
