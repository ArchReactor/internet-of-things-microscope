...
<html>
   <head>
      ...
      <title>Ninju 2 <?php echo CAM_STRING; ?></title>
   ...
   <body onload="setTimeout('init(<?php echo "$mjpegmode, $video_fps, $divider" ?>);', 100);">
      ...
      <div class="container-fluid text-center liveimage">
         <div><img id="mjpeg_dest" class="fullscreen" <?php echo getLoadClass() . getImgWidth();?> <?php if(file_exists("pipan_on")) echo "ontouchstart=\"pipan_start()\""; ?> onclick="toggle_fullscreen(this);" src="./loading.jpg"></div>
